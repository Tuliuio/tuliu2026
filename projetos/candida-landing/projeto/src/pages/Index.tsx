  ...
  return (
    <div className="min-h-screen bg-background font-['Poppins',sans-serif] scroll-smooth">
      ...
      <section className="relative overflow-hidden bg-secondary min-h-screen flex flex-col">
        ...
        {/* Hero doctor image - positioned absolutely to fill the right side */}
        <img src={doctorPortrait} alt="Dra. Cândida Lüdtke" className="absolute bottom-0 right-0 h-full w-[55%] object-contain object-top hidden md:block" width={600} height={800} />
        ...
        <div className="relative z-10 flex-1 max-w-7xl mx-auto px-8 md:px-16 lg:px-20 w-full flex flex-col justify-between">
          <div className="grid md:grid-cols-2 gap-0 items-center flex-1">
            <div className="py-8 md:py-0 flex flex-col justify-center h-full">
              <ScrollReveal>
            ...
            {/* Doctor image now positioned absolutely above */}
          </div>
          ...
          <ScrollReveal delay={500}>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-8 md:gap-20">
              <div className="bg-white/60 backdrop-blur-sm rounded-2xl px-6 py-5 md:px-8 md:py-6">
              ...
              <div className="max-w-md bg-white/60 backdrop-blur-sm rounded-2xl px-6 py-5 md:px-8 md:py-6">
      ...
      <section className="px-6 md:px-12 lg:px-20 py-16 md:py-24 bg-secondary relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 md:gap-16 items-center relative z-10">
          <ScrollReveal>
            <div className="relative">
              <img src={womanReading} alt="Mulher em momento de reflexão" className="w-full max-w-lg rounded-2xl object-cover shadow-xl aspect-[3/4]" loading="lazy" width={600} height={800} />
              <ParallaxLeaf src={leafLeft} className="absolute -bottom-6 -left-8 w-40 md:w-60 z-10" speed={0.05} swayAmount={6} />
            </div>
          </ScrollReveal>
          <div>
          ...
          <ScrollReveal delay={200}>
            <div className="flex flex-wrap justify-center gap-3 md:gap-4 mb-12">
              {[
                ...
                <span key={item.label} className="flex items-center gap-2.5 bg-primary-foreground/20 border border-primary-foreground/50 backdrop-blur-sm rounded-full px-5 py-3 text-sm font-medium transition-colors hover:bg-primary-foreground/30">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 items-stretch relative z-10">
          ...
          <ScrollReveal delay={300}>
            <div className="relative h-full overflow-hidden flex items-end justify-center">
              <img src={doctorAbout} alt="Dra. Cândida Lüdtke" className="h-full w-full object-cover object-top" loading="lazy" width={600} height={800} />
              {/* Decorative circles */}
      ...
      <ScrollReveal>
        <footer className="px-6 md:px-12 lg:px-20 py-14 bg-background border-t border-border relative overflow-hidden">
          <ParallaxLeaf src={leafLeft} className="absolute -bottom-6 -left-6 w-40 md:w-60 z-10" speed={0.06} swayAmount={6} />
